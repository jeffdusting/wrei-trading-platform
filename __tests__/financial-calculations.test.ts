...
describe('WREI Financial Calculations - Core Logic', () => {
  ...
  test('18. WREI Financial Constants Validation', () => {
    expect(WREI_FINANCIAL_CONSTANTS.BASE_CARBON_PRICE).toBe(100);
    expect(WREI_FINANCIAL_CONSTANTS.WREI_PREMIUM_MULTIPLIER).toBe(1.5);
    expect(WREI_FINANCIAL_CONSTANTS.ASSET_CO_BASE_YIELD).toBe(0.283);
    expect(WREI_FINANCIAL_CONSTANTS.DMRV_PREMIUM).toBe(0.78);
    expect(WREI_FINANCIAL_CONSTANTS.RISK_FREE_RATE).toBe(0.04);
  });
