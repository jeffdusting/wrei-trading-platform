            ...
            <div className="bg-blue-50 border border-blue-200 rounded-lg p-6">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
                <div className="bg-white border border-blue-200 rounded-lg p-4">
                  <h4 className="font-semibold text-slate-800">Total Family Wealth</h4>
                  <p className="text-2xl font-bold text-blue-600">A$2.5B</p>
                  <p className="text-sm text-slate-600">Multi-generational assets</p>
                </div>
                <div className="bg-white border border-blue-200 rounded-lg p-4">
                  <h4 className="font-semibold text-slate-800">Investment Horizon</h4>
                  <p className="text-2xl font-bold text-green-600">50+ Years</p>
                  <p className="text-sm text-slate-600">Generational wealth transfer</p>
                </div>
                <div className="bg-white border border-blue-200 rounded-lg p-4">
                  <h4 className="font-semibold text-slate-800">Risk Profile</h4>
                  <p className="text-2xl font-bold text-amber-600">Conservative</p>
                  <p className="text-sm text-slate-600">Capital preservation focus</p>
                </div>
              </div>

              {/* Wealth Preservation Analysis */}
              <div className="mb-6">
                <h4 className="font-semibold text-slate-800 mb-3">📊 Asset Allocation Analysis</h4>
                <div className="overflow-x-auto">
                  <table className="w-full bg-white rounded-lg border border-blue-200">
                    <thead className="bg-blue-100">
                      <tr>
                        <th className="px-4 py-3 text-left font-semibold text-blue-900">Asset Class</th>
                        <th className="px-4 py-3 text-center font-semibold text-blue-900">Current %</th>
                        <th className="px-4 py-3 text-center font-semibold text-blue-900">Target %</th>
                        <th className="px-4 py-3 text-center font-semibold text-blue-900">Risk Level</th>
                        <th className="px-4 py-3 text-center font-semibold text-blue-900">Inflation Hedge</th>
                        <th className="px-4 py-3 text-center font-semibold text-blue-900">Generational</th>
                      </tr>
                    </thead>
                    <tbody>
              ...
              <div className="p-4 bg-white border border-blue-200 rounded-lg">
                <h4 className="font-semibold text-slate-800 mb-2">🎯 Key Recommendations</h4>
        ...
        return (
          <div className="space-y-6">
            <div className="bg-purple-50 border border-purple-200 rounded-lg p-6">
              ...
              <div className="mb-6">
                <h4 className="font-semibold text-slate-800 mb-3">📅 Generational Wealth Transfer Plan</h4>
                  ...
                  {mockSuccessionPlanning.map((plan, index) => (
                    <div key={index} className="bg-white border border-purple-200 rounded-lg p-5">
                      <div className="grid grid-cols-1 lg:grid-cols-3 gap-4">
                        <div>
                          <h5 className="font-semibold text-slate-800 mb-2">{plan.generationLevel}</h5>
                        ...
                        <div className="text-center">
                          <p className="text-sm text-slate-600 mb-1">Wealth Transfer Target</p>
              ...
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                <div className="bg-white border border-purple-200 rounded-lg p-5">
                  <h4 className="font-semibold text-slate-800 mb-4">🏛️ Family Governance Structure</h4>
                ...
                <div className="bg-white border border-purple-200 rounded-lg p-5">
                  <h4 className="font-semibold text-slate-800 mb-4">🌱 ESG & Impact Alignment</h4>
                  ...
                  <div className="space-y-4">
                    <div className="border-l-4 border-green-500 pl-4">
                      ...
                      <div className="text-xs text-green-600 mt-2 font-medium">Target: 25% of alternatives allocation</div>
                    </div>
                    ...
                    <div className="border-l-4 border-blue-500 pl-4">
                      ...
                      <div className="text-xs text-blue-600 mt-2 font-medium">Foundation allocation: A$500M</div>
                    </div>
                    ...
                    <div className="border-l-4 border-purple-500 pl-4">
                      ...
                      <div className="text-xs text-purple-600 mt-2 font-medium">Quarterly family impact reports</div>
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div className="mt-6 p-4 bg-white border border-purple-200 rounded-lg">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mt-3">
                  <div className="text-center">
                    <div className="text-lg font-bold text-purple-600">2026-2030</div>
                    <div className="text-sm font-medium text-slate-800">Foundation Phase</div>
                    <div className="text-xs text-slate-600">Governance setup & education</div>
                  </div>
                  <div className="text-center">
                    <div className="text-lg font-bold text-blue-600">2030-2045</div>
                    <div className="text-sm font-medium text-slate-800">Transition Phase</div>
                    <div className="text-xs text-slate-600">Gradual wealth transfer</div>
                  </div>
                  <div className="text-center">
                    <div className="text-lg font-bold text-green-600">2045-2075</div>
                    <div className="text-sm font-medium text-slate-800">Legacy Phase</div>
                    <div className="text-xs text-slate-600">Next generation leadership</div>
                  </div>
                </div>
              </div>
            ...
            <div className="bg-green-50 border border-green-200 rounded-lg p-6">
              ...
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                ...
                <div className="bg-white border border-green-200 rounded-lg p-5">
                  <h4 className="font-semibold text-slate-800 mb-4">💎 WREI Asset Co Token Benefits</h4>
                ...
                <div className="bg-white border border-green-200 rounded-lg p-5">
                  <h4 className="font-semibold text-slate-800 mb-4">📊 Proposed Investment Structure</h4>

                  <div className="space-y-3">
                    <div className="flex justify-between items-center pb-2 border-b border-slate-200">
                      <span className="text-slate-600">Target Allocation</span>
                      <span className="font-semibold text-green-600">3.0% of Portfolio</span>
                    </div>
                    <div className="flex justify-between items-center pb-2 border-b border-slate-200">
                      <span className="text-slate-600">Investment Amount</span>
                      <span className="font-semibold">A$75,000,000</span>
                    </div>
                    <div className="flex justify-between items-center pb-2 border-b border-slate-200">
                      <span className="text-slate-600">Token Quantity</span>
                      <span className="font-semibold">750,000 ACO-WTR</span>
                    </div>
                    <div className="flex justify-between items-center pb-2 border-b border-slate-200">
                      <span className="text-slate-600">Expected Yield</span>
                      <span className="font-semibold text-green-600">5.8% p.a.</span>
                    </div>
                    <div className="flex justify-between items-center pb-2 border-b border-slate-200">
                    ...
                    <div className="flex justify-between items-center">
                      ...
                      <span className="font-semibold">Quarterly redemptions</span>
                    </div>
                  </div>
              ...
              <div className="mt-6 p-4 bg-white border border-green-200 rounded-lg">
                <h4 className="font-semibold text-slate-800 mb-3">⚖️ Risk Assessment & Mitigation</h4>
              ...
              <div className="mt-6 p-4 bg-white border border-green-200 rounded-lg">
                <h4 className="font-semibold text-slate-800 mb-2">🎯 Next Step: Family Investment Committee Approval</h4>
          ...
          <div className="space-y-6">
            <div className="bg-indigo-50 border border-indigo-200 rounded-lg p-6">
              ...
              <div className="bg-white border border-indigo-200 rounded-lg p-4 mb-4">
                <h4 className="font-semibold text-slate-800 mb-2">🏛️ Family Office Context</h4>
              ...
              <div className="bg-white border border-indigo-200 rounded-lg">
                <div className="border-b border-indigo-200 p-4">
                  <h4 className="font-semibold text-slate-800">💬 Acquisition Negotiation</h4>
                </div>
            ...
            <div className="bg-blue-50 border border-blue-200 rounded-lg p-6">
              ...
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                ...
                <div className="bg-white border border-blue-200 rounded-lg p-5">
                  <h4 className="font-semibold text-slate-800 mb-4">📋 Investment Committee Oversight</h4>
                  ...
                  <div className="space-y-3">
                    <div className="p-3 bg-blue-50 border border-blue-200 rounded">
                      ...
                      <div className="text-xs text-blue-600 mt-2">Next Review: July 15, 2026</div>
                    </div>
                    ...
                    <div className="p-3 bg-purple-50 border border-purple-200 rounded">
                      ...
                      <div className="text-xs text-purple-600 mt-2">8 family members actively engaged</div>
                    </div>
                  </div>
                </div>
                ...
                {/* Reporting Framework */}
                <div className="bg-white border border-blue-200 rounded-lg p-5">
                  <h4 className="font-semibold text-slate-800 mb-4">📊 Family Reporting Framework</h4>
                  ...
                  <div className="space-y-4">
                    <div className="border-l-4 border-blue-500 pl-4">
                      ...
                      <div className="text-xs text-blue-600 mt-2">Distribution: All family stakeholders</div>
                    </div>
                    ...
                    <div className="border-l-4 border-green-500 pl-4">
                      ...
                      <div className="text-xs text-green-600 mt-2">Format: Executive summary + detailed analysis</div>
                    </div>
                    ...
                    <div className="border-l-4 border-purple-500 pl-4">
                      ...
                      <div className="text-xs text-purple-600 mt-2">Focus: Multi-generational impact</div>
                    </div>
                    ...
                    <div className="border-l-4 border-amber-500 pl-4">
                      ...
                      <div className="text-xs text-amber-600 mt-2">Delivery: As required</div>
                    </div>
                  </div>
                </div>
              </div>
      ...
      <div className="max-w-7xl mx-auto px-4">
        ...
        <div className="bg-white border border-slate-200 rounded-lg p-6 mb-8">
          <div className="flex items-center justify-between mb-4">
            <div>
              <h1 className="text-3xl font-bold text-slate-800">Family Office Journey</h1>
            ...
            <div className="text-right">
              ...
              <div className="text-lg font-semibold text-blue-600">Core Investor Journeys</div>
            </div>
          </div>
