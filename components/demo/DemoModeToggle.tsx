    ...
    return (
      <div className={`flex items-center gap-2 ${className}`}>
        <div className="flex items-center gap-1.5 px-2 py-1 bg-green-500/20 text-green-400 rounded border border-green-500/30">
          ...
          <span className="text-xs font-medium">Demo Active</span>
        </div>
        <button
  ...
  return (
    <div className={`relative ${className}`} ref={dropdownRef}>
      <button
        ...
        className="flex items-center gap-1.5 px-3 py-1.5 bg-gradient-to-r from-blue-600 to-blue-700 hover:from-blue-700 hover:to-blue-800 text-white rounded-md text-sm font-medium transition-all duration-200 shadow-sm hover:shadow-md"
      >
        <svg
        ...
        <div className="absolute top-full right-0 mt-2 w-72 bg-white border border-gray-200 rounded-lg shadow-xl z-[100]">
          <div className="p-3">
            ...
            <div className="space-y-1">
              ...
              >
                <div className="font-medium text-gray-900 text-sm">Executive Overview</div>
                <div className="text-xs text-gray-600">12 min high-level platform tour</div>
              </button>
              ...
              >
                <div className="font-medium text-gray-900 text-sm">Investor Deep Dive</div>
                <div className="text-xs text-gray-600">18 min comprehensive experience</div>
              </button>
              ...
              >
                <div className="font-medium text-gray-900 text-sm">Technical Integration</div>
                <div className="text-xs text-gray-600">15 min developer-focused tour</div>
              </button>
              ...
              >
                <div className="font-medium text-gray-900 text-sm">Carbon Negotiation</div>
                <div className="text-xs text-gray-600">8 min AI negotiation demo</div>
              </button>
              ...
              <button
                ...
                className="w-full text-left p-2 rounded-md hover:bg-amber-50 border border-transparent hover:border-amber-200 transition-colors"
              >
                <div className="font-medium text-gray-900 text-sm">Presentation Mode</div>
                <div className="text-xs text-gray-600">Guided investor presentation</div>
              </button>
              ...
              >
                <div className="font-medium text-gray-900 text-sm">Free Explore</div>
                <div className="text-xs text-gray-600">Demo mode without guided tour</div>
              </button>
            </div>
          </div>
        </div>
